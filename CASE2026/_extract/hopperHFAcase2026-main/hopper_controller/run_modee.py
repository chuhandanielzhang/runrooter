...
Examples:
  ...
  python3 run_modee.py --print-hz 5
    ...
    ap.add_argument(
        ...
        type=float,
        default=None,
        help="INTERNAL torque limit (Nm) used by WBC-QP feasibility. Default: 20.0. "
    ...
    ap.add_argument(
        ...
        default=None,
        choices=[1, 2, 3],
        help="Control mode: 1=pure_leg (no props), 2=decouple (leg QP + prop overlay), 3=unified QP. Default: 3",
    )
    ap.add_argument(
        "--stance-use-props",
        action="store_true",
    ...
    _mode_names = {1: "PURE LEG (no props)", 2: "DECOUPLE (leg QP + prop overlay)", 3: "UNIFIED QP (leg+prop)"}
    print("=" * 58)
