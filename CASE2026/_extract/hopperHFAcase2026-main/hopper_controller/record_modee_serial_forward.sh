...
OUT_MP4="$OUT_DIR/case_modee_serial_forward.mp4"
...
# --cmd-switch-after-s 3.0: hop in place (vx=0) for 3s after release
# --cmd-vx1 0.30: move forward at 0.3 m/s
# --cmd-switch2-after-s 8.0: switch back to in place after 8s (3s + 5s)
