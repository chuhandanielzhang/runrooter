...
MJ=$!
sleep 2
CAO_L0=${CAO_L0:-0.42} CAO_HOP_H=${CAO_HOP_H:-0.20} CAO_MODE=${CAO_MODE:-3} CAO_TAU=${CAO_TAU:-25} CAO_ST_KR=${CAO_ST_KR:-} CAO_ST_KW=${CAO_ST_KW:-} CAO_FL_KR=${CAO_FL_KR:-} CAO_FL_KW=${CAO_FL_KW:-} CAO_PROP_BASE=${CAO_PROP_BASE:-} \
